...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-orange-50 via-slate-50 to-orange-50 px-4">
      ...
      >
        ...
        <button 
            type="submit" 
            disabled={isLoading}
            className={`w-full mt-8 text-white py-3.5 rounded-xl font-bold text-lg shadow-lg transition-all flex justify-center items-center gap-2 ${
              isLoading 
