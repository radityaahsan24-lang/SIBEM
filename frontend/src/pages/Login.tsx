...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-orange-50 px-4">
      ...
      >
        ...
        <button 
            type="submit" 
            className="w-full mt-8 bg-orange-500 hover:bg-orange-600 text-white py-3.5 rounded-xl font-bold text-lg shadow-lg shadow-orange-500/30 transition-all active:scale-[0.98]"
        >
          Masuk
        </button>
      </form>
